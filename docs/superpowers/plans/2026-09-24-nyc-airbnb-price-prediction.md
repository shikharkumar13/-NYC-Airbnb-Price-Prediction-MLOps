...
> **Status (2026-09-24):** Tasks 1–10 are implemented. Where the code in the repo differs from the snippets below, **the repo is the source of truth**. The differences are:
